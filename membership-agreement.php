...
$title = $membershipAgreement->header;
...
<html lang="en">
  <head>
    ...
    <title>Firestrom Membership Agreement</title>
  ...
  <body>
    ...
    <div class="container-fluid hero-img" style="margin-top:-15px;">
      ...
      <div class="row no-gutter slider-navigation header-text">
        <div class="container">
            <h1 class="fs-header-white text-left">Membership<span class="fs-strong">Agreement</span></h1>
        </div>
      </div>
    </div>
