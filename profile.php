<?php 
  ...
  if(isset($_GET["user"]) && $_GET["user"]!=''){
    ...
    $expertList = $user->print_user_expertise_list($profInfo["expertise"]);
  ...
  <body>
    ...
    <div class="container-fluid cover-img visible-md visible-lg">
        <div class="row img-holder">
          <img src="<?php if($profInfo["covPic"] != "") { print($profInfo["covPic"]); } else { print("img/placeholder-img.jpg"); }?>" class="img-reponsive">
        </div>
    </div>
      ...
      <div class="row">
           <div class="col-sm-3 event-details">
              <div class="wrapper featured-member profile-img">
                  <img id="profilePic" class="img-responsive img-circle center-block" src="<?php if($profInfo["profPic"] != "") { print($profInfo["profPic"]); } else { print("img/placeholder_user.png"); }?>" alt="<?php print($name);?> Profile Picture">
              </div>
           </div>
    ...
    <div class="container info">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-12">
                        <h4 class="fs-header text-left">Industry</h4>
                        <p class="fs-header-black" id="compIndustry"><?php print($profInfo["industryName"]);?></p>
                    </div>
             ...
             <h4 class="fs-header text-left">Chapters <span class="fs-strong">Enrolled</span></h4>
              <ul class="list-inline groups">
                 <?php $chapters->printUserChapters($userID, null); ?>
              </ul>
      ...
      <div class="row">
        <div class="col-xs-6 col-md-10 col-md-offset-1">
            ...
            <a class="btn btn-default fs-btn-orange btn-md" id="refer" data-toggle="modal" data-target="#referWindow" href="#" title="Refer">Refer</a>
    ...
    <div class="container result-boxes bg-grey">
        <div class="row ">
            <div class="col-xs-12 col-sm-6 col-md-4 bg-grey">
                <div class="thumbnail">
                    <div class="img-container">
                        <a href="event.php" title="event title"> <img class="img-responsive" src="img/event-placeholder.jpg" alt="placeholder"></a>
                    </div>
                    <div class="caption">
                        <p class="date">Wed, MAR 29 2017 8:00am</p>
                            <a class="event.php" href="link-to-event" title="event title">
                                <h5 class="fs-header-black"><span class="fs-strong">Broomfield Business to Business Speed Networkingz</span></h5>
                            </a>
                        <a class="location-link" href="link-to-google-map" title="repeat location">Westmoor Conference Center, Westminister  <i class="fa fa-map-marker pull-right" aria-hidden="true"></i></a>
                        <div class="row">
                        <div class="col-xs-12">
                        <ul class="list-inline tags">
                            ...
                            <li class="list-group-item">#Tag 4</li>
                        </ul>
                        </div>
    ...
    <div class="container  bg-grey">
        <div class="row">
            <h2 class="fs-header h3 text-center">Bookmarked <span class="fs-strong">Events</span></h2>
        </div>
    </div>
