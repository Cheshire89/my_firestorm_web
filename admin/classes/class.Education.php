	...
	class Education extends fireSQL{
		...
		function getAdminArticles(){
			...
			while($row = $data->fetch_assoc()){
				...
				$resultHTML .= '<tr>
                            <td><a href="createArticle.php?articleID='.$row["articleID"].'" target="_blank"><img class="img-responsive center-block" src="'.$row["articleImg"].'" alt="'.$row["articleTitle"].'"></a></td>
                            <td class="title"><a href="createArticle.php?articleID='.$row["articleID"].'" target="_blank">'.$row["articleTitle"].'</a></td>
                            <td>'.$row["articleBy"].'</td>
