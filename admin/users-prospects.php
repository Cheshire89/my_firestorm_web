<?php
    ...
    $prospects = new Users();
    $adminProspects = $prospects->get_admin_prospects();
                ...
                <nav class="navbar">
                    <div class="navbar-collapse">
                      <ul class="nav nav-justified">
                          ...
                          <li><a href="users-archived.php" title="">Archived</a></li>
                      </ul>
                    </div>
                </nav>
                </div>
               ...
               <div class="col-xs-12">
                  ...
                  <div class="panel-heading"><h3>Manage Prospects</h3></div>
                    ...
                    <div class="row table-addon">
                      <div class="col-xs-12">
                        <div class="btn-group pull-right">
                                <button type="button" class="btn btn-sm fs-btn-green add addProspect" id="approveProspects"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Approve</button> 
