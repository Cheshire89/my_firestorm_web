...
$users = new Users();
$adminUsers = $users->get_admin_users();
...
<html lang="en">
  <head>
    ...
    <title>Firestorm Admin Members | Authenticated</title>
                ...
                <nav class="navbar">
                    <div class="navbar-collapse">
                      <ul class="nav nav-justified">
                          <li class="active"><a href="users-authenticated.php" title="">Authenticated</a></li>
