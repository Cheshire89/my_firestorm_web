      ...
      <nav class="navbar">
          <div class="navbar-collapse">
            <ul class="nav nav-justified">
                  <li class="active"><a href="index.php" title="">Profile</a></li>
    ...
    <div class="container result-boxes bg-grey">
        <div class="row ">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 bg-grey">
                <div class="thumbnail">
                    <div class="img-container">
                        <a href="event.php" title="event title"> <img class="img-responsive" src="img/networking.jpg" alt="placeholder"></a>
                    </div>
                    <div class="caption">
                        <p class="date">Wed, MAR 29 2017 8:00am</p>
                            <a class="event.php" href="link-to-event" title="event title">
