                ...
                <div class="col-xs-12">
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <form class="form-horizontal fs-form-gen" action="saveMembershipAgreement.php" name="saveMembershipAgreement" method="POST">
                             <div class="col-xs-12">
                               <div class="form-group">
                                  <div class="input-group">
                                      <input type="text" class="form-control" id="membershipAgreementHeader" name="membershipAgreementHeader" placeholder="Main Header">
                                      <span class="input-group-addon">H</span>
                                  </div>
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" id="membershipAgreementText" name="membershipAgreementText" placeholder="Membership Agreement Content"></textarea>
                                </div>
